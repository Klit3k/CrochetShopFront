...
function GetListOfProducts() {
  ...
  const [mode, setMode] = useState(false); //false - products ; true - categories
  useEffect(() => {
    axios
  ...
  return !state.loaded ? null : (
    <div className="Home mb-5">
      ...
      {
      list.products.length === 0 ? (<div className='container mt-4'>
   ...
   (
    ...
    <button className="btn btn-outline-dark btn-sm mx-1" onClick={handleProductClick}>Wyświetl produkty</button>
    <button className="btn btn-outline-dark btn-sm mx-1" onClick={handleCategoryClick}>Wyświetl kategoriami</button>

    <div className="row g-6 d-flex justify-content-center">     
    <div className="d-flex justify-content-center">
      <h4>Dostępne produkty ({list.products.length})</h4>
    </div>
