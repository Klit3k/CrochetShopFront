...
const RemoveProduct = () => {
        ...
        var listProductServer = async () => {
            ...
            .then((response) => {
                ...
                setList({ products: response.data });
        ...
        const handleSubmit = (event) => {
              ...
              axios.delete("http://localhost:8080/product", {
                    params: {
                    ...
                    setAlertInfo(true);
                    setReload(!reload);
                }).catch(err => console.log("Coś poszło nie tak."))
            ...
            <form onSubmit={handleSubmit}>
               ...
               <div className="form-row">
                ...
                <div className="mb-3 col-3 mx-auto">
                  {list.products.length > 0 && product.image !== undefined ? 
                  <img src={"data:image/png;base64,"+product.image.file} alt={product.image.name} className="img-thumbnail"></img>
                  : null}
                </div>
                 ...
                 <div className="d-flex justify-content-center">
                    <button type="submit" className="btn btn-primary mb-5" >Usuń produkt</button>
                </div>
